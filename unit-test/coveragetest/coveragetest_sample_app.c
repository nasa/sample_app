...
void Test_SAMPLE_ReportHousekeeping(void)
{
     ...
     */
    UT_SetDataBuffer(UT_KEY(CFE_SB_SendMsg), &HkTelemetryMsg, sizeof(HkTelemetryMsg), false);
     ...
     */
    UtAssert_True(HkTelemetryMsg.Payload.CommandCounter == 22, "HkTelemetryMsg.Payload.CommandCounter (%u) == 22",
